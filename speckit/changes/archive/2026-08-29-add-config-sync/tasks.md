...
- [x] 8.1 写 commit message:`feat(profiles): add cowboy config sync subcommand to reconcile profiles from disk to DB`
- [x] 8.2 push 远端
- [x] 8.3 `/opsx:archive` 把本次 change 移到 `speckit/changes/archive/`
